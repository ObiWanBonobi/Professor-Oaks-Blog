""" Test for the blog.views.py file """

from django.contrib.auth.models import User
from django.urls import reverse
from django.test import TestCase
from user_profile.models import Socials
...
class TestBlogViews(TestCase):
    """
    Tests all blog views, like :view:`blog.post_detail`
    """
    def setUp(self):
        """
        Provides initial settings for our tests to use
        """
    ...
    #     """
    #     Checks a single blog post that also has a comment in it
    #     """
